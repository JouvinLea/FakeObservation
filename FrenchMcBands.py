...
class FrenchMcBands(object):
    """
    Determine the MC simulation number for each of your MC observational condition
    """
    ...
    def find_azimuth_digit(self, az):
        ...
        """
        i=np.where(np.asarray(self.azimuth)==az)[0][0]
    ...
    def find_zenMC_digit(self, zen):
        ...
        """
        i=np.where(np.asarray(self.zenMC)==zen)[0][0]
    ...
    def find_offMC_digit(self, off):
        ...
        """
        i=np.where(np.asarray(self.offMC)==off)[0][0]
    ...
    def find_enMC_digit(self, E):
        ...
        """
        i=np.where(np.asarray(self.enMC)==E)[0][0]
